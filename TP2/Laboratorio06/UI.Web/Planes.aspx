            ...
            <div class="col">
                <div class="row">
                    <asp:Panel ID="formPanel" Visible="false" runat="server">
                        ...
                        <div>
                            <asp:Label ID="especialidadLabel" runat="server" Text="ID Especialidad: "></asp:Label>
                        </div>
                        <div>
                            <asp:DropDownList ID="DropDownListEspecialidades" runat="server" DataValueField="Id" DataTextField="Descripcion">
                            </asp:DropDownList>
                            <asp:RequiredFieldValidator ID="rqEspecialidad" runat="server" ControlToValidate="DropDownListEspecialidades" ErrorMessage="* Seleccione la especialidad" ForeColor="#CC3300"></asp:RequiredFieldValidator>
                        </div>
                    </asp:Panel>
                </div>
